...
| 6 | iframe-Höhe | **Datenfeld `iframeHeight` je Station** (Default 1400), Arabisch +10 % | JavaScript in Labels ist theme-abhängig (Memory `format-tiles-modal-scripts`); ein Datenfeld ist deterministisch |
